# note: eliakim s paper remove low values for NDVI. Here we remove low values for
# each of the bands

wrap <- function(multibandsarr, multibandsarrno, timearr, history, lastordetect, 
    hisweight, pcacomp, moy, scoreselect, sca) {
    a1 <- bfmPCA(multibandsarr = multibandsarr, timearr = timearr, history = history, 
        ...
        scoreselect = scoreselect, sca = sca)
...
wrapVI <- function(multibandsarr, multibandsarrno, timearr, history, pcacomp, moy) {
...
# Brazil
brvali <- valitable(valichartBrazil2, Braziltime, brbo5, totalp = 470, EarlyDateIsCommission = F, 
...
# save(Boliviaarrno, file='data/Boliviaarrno.rda') save(Brazilarrno,
# file='data/Brazilarrno.rda') save(Boliviaarr, file='data/Boliviaarr.rda')
# save(Brazilarr, file='data/Brazilarr.rda')
# save(Braziltime,file='data/Braziltime.rda')
# save(time_B1000,file='data/time_B1000.rda') save(bobo5,file='data/bobo5.rda')
# save(brbo5, file='data/brbo5.rda') save(BDbo,file='data/BDbo.rda') save(BDbr,
# file='data/BDbr.rda') save(valichartbo,file='data/valichartbo.rda')
